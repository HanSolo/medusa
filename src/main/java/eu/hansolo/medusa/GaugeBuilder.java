    ...
    public final Gauge build() {
        ...
        properties.forEach((key, property) -> {
            switch (key) {
                ...
                case "prefWidth"                        -> gauge.setPrefWidth(((DoubleProperty) property).get());
                case "prefHeight"                       -> gauge.setPrefHeight(((DoubleProperty) property).get());
                case "minWidth"                         -> gauge.setMinWidth(((DoubleProperty) property).get());
                case "minHeight"                        -> gauge.setMinHeight(((DoubleProperty) property).get());
                case "maxWidth"                         -> gauge.setMaxWidth(((DoubleProperty) property).get());
                case "maxHeight"                        -> gauge.setMaxHeight(((DoubleProperty) property).get());
                case "scaleX"                           -> gauge.setScaleX(((DoubleProperty) property).get());
                case "scaleY"                           -> gauge.setScaleY(((DoubleProperty) property).get());
                case "layoutX"                          -> gauge.setLayoutX(((DoubleProperty) property).get());
                case "layoutY"                          -> gauge.setLayoutY(((DoubleProperty) property).get());
                case "translateX"                       -> gauge.setTranslateX(((DoubleProperty) property).get());
                case "translateY"                       -> gauge.setTranslateY(((DoubleProperty) property).get());
                case "padding"                          -> gauge.setPadding(((ObjectProperty<Insets>) property).get());
                case "styleClass"                       -> {
                    gauge.getStyleClass().setAll("gauge");
                    gauge.getStyleClass().addAll(((ObjectProperty<String[]>) property).get());
                }
                case "decimals"                         -> gauge.setDecimals(((IntegerProperty) property).get());
                case "tickLabelDecimals"                -> gauge.setTickLabelDecimals(((IntegerProperty) property).get());
                case "title"                            -> gauge.setTitle(((StringProperty) property).get());
                case "subTitle"                         -> gauge.setSubTitle(((StringProperty) property).get());
                case "unit"                             -> gauge.setUnit(((StringProperty) property).get());
                case "averagingEnabled"                 -> gauge.setAveragingEnabled(((BooleanProperty) property).get());
                case "averagingPeriod"                  -> gauge.setAveragingPeriod(((IntegerProperty) property).get());
                case "startFromZero"                    -> gauge.setStartFromZero(((BooleanProperty) property).get());
                case "returnToZero"                     -> gauge.setReturnToZero(((BooleanProperty) property).get());
                case "zeroColor"                        -> gauge.setZeroColor(((ObjectProperty<Color>) property).get());
                case "minMeasuredValueVisible"          -> gauge.setMinMeasuredValueVisible(((BooleanProperty) property).get());
                case "maxMeasuredValueVisible"          -> gauge.setMaxMeasuredValueVisible(((BooleanProperty) property).get());
                case "oldValueVisible"                  -> gauge.setOldValueVisible(((BooleanProperty) property).get());
                case "valueVisible"                     -> gauge.setValueVisible(((BooleanProperty) property).get());
                case "backgroundPaint"                  -> gauge.setBackgroundPaint(((ObjectProperty<Paint>) property).get());
                case "borderPaint"                      -> gauge.setBorderPaint(((ObjectProperty<Paint>) property).get());
                case "borderWidth"                      -> gauge.setBorderWidth(((DoubleProperty) property).get());
                case "foregroundPaint"                  -> gauge.setForegroundPaint(((ObjectProperty<Paint>) property).get());
                case "knobColor"                        -> gauge.setKnobColor(((ObjectProperty<Color>) property).get());
                case "knobType"                         -> gauge.setKnobType(((ObjectProperty<KnobType>) property).get());
                case "knobPosition"                     -> gauge.setKnobPosition(((ObjectProperty<Pos>) property).get());
                case "knobVisible"                      -> gauge.setKnobVisible(((BooleanProperty) property).get());
                case "animated"                         -> gauge.setAnimated(((BooleanProperty) property).get());
                case "animationDuration"                -> gauge.setAnimationDuration(((LongProperty) property).get());
                case "startAngle"                       -> gauge.setStartAngle(((DoubleProperty) property).get());
                case "angleRange"                       -> gauge.setAngleRange(((DoubleProperty) property).get());
                case "arcExtend"                        -> gauge.setArcExtend(((DoubleProperty) property).get());
                case "needleType"                       -> gauge.setNeedleType(((ObjectProperty<NeedleType>) property).get());
                case "needleShape"                      -> gauge.setNeedleShape(((ObjectProperty<NeedleShape>) property).get());
                case "needleSize"                       -> gauge.setNeedleSize(((ObjectProperty<NeedleSize>) property).get());
                case "needleBehavior"                   -> gauge.setNeedleBehavior(((ObjectProperty<NeedleBehavior>) property).get());
                case "needleColor"                      -> gauge.setNeedleColor(((ObjectProperty<Color>) property).get());
                case "needleBorderColor"                -> gauge.setNeedleBorderColor(((ObjectProperty<Color>) property).get());
                case "barColor"                         -> gauge.setBarColor(((ObjectProperty<Color>) property).get());
                case "barBorderColor"                   -> gauge.setBarBorderColor(((ObjectProperty<Color>) property).get());
                case "barBackgroundColor"               -> gauge.setBarBackgroundColor(((ObjectProperty<Color>) property).get());
                case "tickLabelOrientation"             -> gauge.setTickLabelOrientation(((ObjectProperty<TickLabelOrientation>) property).get());
                case "tickLabelLocation"                -> gauge.setTickLabelLocation(((ObjectProperty<TickLabelLocation>) property).get());
                case "locale"                           -> gauge.setLocale(((ObjectProperty<Locale>) property).get());
                case "majorTickSpace"                   -> gauge.setMajorTickSpace(((DoubleProperty) property).get());
                case "minorTickSpace"                   -> gauge.setMinorTickSpace(((DoubleProperty) property).get());
                case "shadowsEnabled"                   -> gauge.setShadowsEnabled(((BooleanProperty) property).get());
                case "barEffectEnabled"                 -> gauge.setBarEffectEnabled(((BooleanProperty) property).get());
                case "scaleDirection"                   -> gauge.setScaleDirection(((ObjectProperty<ScaleDirection>) property).get());
                case "tickLabelColor"                   -> gauge.setTickLabelColor(((ObjectProperty<Color>) property).get());
                case "tickMarkColor"                    -> gauge.setTickMarkColor(((ObjectProperty<Color>) property).get());
                case "majorTickMarkColor"               -> gauge.setMajorTickMarkColor(((ObjectProperty<Color>) property).get());
                case "majorTickMarkLengthFactor"        -> gauge.setMajorTickMarkLengthFactor(((DoubleProperty) property).get());
                case "majorTickMarkWidthFactor"         -> gauge.setMajorTickMarkWidthFactor(((DoubleProperty) property).get());
                case "mediumTickMarkColor"              -> gauge.setMediumTickMarkColor(((ObjectProperty<Color>) property).get());
                case "mediumTickMarkLengthFactor"       -> gauge.setMediumTickMarkLengthFactor(((DoubleProperty) property).get());
                case "mediumTickMarkWidthFactor"        -> gauge.setMediumTickMarkWidthFactor(((DoubleProperty) property).get());
                case "minorTickMarkColor"               -> gauge.setMinorTickMarkColor(((ObjectProperty<Color>) property).get());
                case "minorTickMarkLengthFactor"        -> gauge.setMinorTickMarkLengthFactor(((DoubleProperty) property).get());
                case "minorTickMarkWidthFactor"         -> gauge.setMinorTickMarkWidthFactor(((DoubleProperty) property).get());
                case "style"                            -> gauge.setStyle(((StringProperty) property).get());
                case "ledColor"                         -> gauge.setLedColor(((ObjectProperty<Color>) property).get());
                case "ledType"                          -> gauge.setLedType(((ObjectProperty<LedType>) property).get());
                case "ledVisible"                       -> gauge.setLedVisible(((BooleanProperty) property).get());
                case "lcdVisible"                       -> gauge.setLcdVisible(((BooleanProperty) property).get());
                case "lcdCrystalEnabled"                -> gauge.setLcdCrystalEnabled(((BooleanProperty) property).get());
                case "lcdDesign"                        -> gauge.setLcdDesign(((ObjectProperty<LcdDesign>) property).get());
                case "lcdFont"                          -> gauge.setLcdFont(((ObjectProperty<LcdFont>) property).get());
                case "innerShadowEnabled"               -> gauge.setInnerShadowEnabled(((BooleanProperty) property).get());
                case "thresholdVisible"                 -> gauge.setThresholdVisible(((BooleanProperty) property).get());
                case "averageVisible"                   -> gauge.setAverageVisible(((BooleanProperty) property).get());
                case "sectionsVisible"                  -> gauge.setSectionsVisible(((BooleanProperty) property).get());
                case "sectionsAlwaysVisible"            -> gauge.setSectionsAlwaysVisible(((BooleanProperty) property).get());
                case "sectionTextVisible"               -> gauge.setSectionTextVisible(((BooleanProperty) property).get());
                case "sectionIconsVisible"              -> gauge.setSectionIconsVisible(((BooleanProperty) property).get());
                case "highlightSections"                -> gauge.setHighlightSections(((BooleanProperty) property).get());
                case "areasVisible"                     -> gauge.setAreasVisible(((BooleanProperty) property).get());
                case "areaTextVisible"                  -> gauge.setAreaTextVisible(((BooleanProperty) property).get());
                case "areaIconsVisible"                 -> gauge.setAreaIconsVisible(((BooleanProperty) property).get());
                case "highlightAreas"                   -> gauge.setHighlightAreas(((BooleanProperty) property).get());
                case "tickMarkSectionsVisible"          -> gauge.setTickMarkSectionsVisible(((BooleanProperty) property).get());
                case "tickLabelSectionsVisible"         -> gauge.setTickLabelSectionsVisible(((BooleanProperty) property).get());
                case "markersVisible"                   -> gauge.setMarkersVisible(((BooleanProperty) property).get());
                case "majorTickMarkType"                -> gauge.setMajorTickMarkType(((ObjectProperty<TickMarkType>) property).get());
                case "mediumTickMarkType"               -> gauge.setMediumTickMarkType(((ObjectProperty<TickMarkType>) property).get());
                case "minorTickMarkType"                -> gauge.setMinorTickMarkType(((ObjectProperty<TickMarkType>) property).get());
                case "titleColor"                       -> gauge.setTitleColor(((ObjectProperty<Color>) property).get());
                case "subTitleColor"                    -> gauge.setSubTitleColor(((ObjectProperty<Color>) property).get());
                case "unitColor"                        -> gauge.setUnitColor(((ObjectProperty<Color>) property).get());
                case "valueColor"                       -> gauge.setValueColor(((ObjectProperty<Color>) property).get());
                case "thresholdColor"                   -> gauge.setThresholdColor(((ObjectProperty<Color>) property).get());
                case "averageColor"                     -> gauge.setAverageColor(((ObjectProperty<Color>) property).get());
                case "tickLabelsVisible"                -> gauge.setTickLabelsVisible(((BooleanProperty) property).get());
                case "onlyFirstAndLastTickLabelVisible" -> gauge.setOnlyFirstAndLastTickLabelVisible(((BooleanProperty) property).get());
                case "majorTickMarksVisible"            -> gauge.setMajorTickMarksVisible(((BooleanProperty) property).get());
                case "mediumTickMarksVisible"           -> gauge.setMediumTickMarksVisible(((BooleanProperty) property).get());
                case "minorTickMarksVisible"            -> gauge.setMinorTickMarksVisible(((BooleanProperty) property).get());
                case "tickMarkRingVisible"              -> gauge.setTickMarkRingVisible(((BooleanProperty) property).get());
                case "ledBlinking"                      -> gauge.setLedBlinking(((BooleanProperty) property).get());
                case "ledOn"                            -> gauge.setLedOn(((BooleanProperty) property).get());
                case "orientation"                      -> gauge.setOrientation(((ObjectProperty<Orientation>) property).get());
                case "gradientBarEnabled"               -> gauge.setGradientBarEnabled(((BooleanProperty) property).get());
                case "gradientLookup"                   -> gauge.setGradientLookup(((ObjectProperty<GradientLookup>) property).get());
                case "customTickLabelsEnabled"          -> gauge.setCustomTickLabelsEnabled(((BooleanProperty) property).get());
                case "customTickLabelFontSize"          -> gauge.setCustomTickLabelFontSize(((DoubleProperty) property).get());
                case "customTickLabelFontSizeEnabled"   -> gauge.setCustomTickLabelFontSizeEnabled(((BooleanProperty) property).get());
                case "interactive"                      -> gauge.setInteractive(((BooleanProperty) property).get());
                case "checkSectionsForValue"            -> gauge.setCheckSectionsForValue(((BooleanProperty) property).get());
                case "checkAreasForValue"               -> gauge.setCheckAreasForValue(((BooleanProperty) property).get());
                case "checkThreshold"                   -> gauge.setCheckThreshold(((BooleanProperty) property).get());
                case "onValueChanged"                   -> gauge.currentValueProperty().addListener(((ObjectProperty<InvalidationListener>) property).get());
                case "onButtonPressed"                  -> gauge.setOnButtonPressed(((ObjectProperty<EventHandler>) property).get());
                case "onButtonReleased"                 -> gauge.setOnButtonReleased(((ObjectProperty<EventHandler>) property).get());
                case "onThresholdExceeded"              -> gauge.setOnThresholdExceeded(((ObjectProperty<EventHandler>) property).get());
                case "onThresholdUnderrun"              -> gauge.setOnThresholdUnderrun(((ObjectProperty<EventHandler>) property).get());
                case "buttonTooltipText"                -> gauge.setButtonTooltipText(((StringProperty) property).get());
                case "keepAspect"                       -> gauge.setKeepAspect(((BooleanProperty) property).get());
                case "threshold"                        -> gauge.setThreshold(((DoubleProperty) property).get());
                case "customFontEnabled"                -> gauge.setCustomFontEnabled(((BooleanProperty) property).get());
                case "customFont"                       -> gauge.setCustomFont(((ObjectProperty<Font>) property).get());
                case "alertMessage"                     -> gauge.setAlertMessage(((StringProperty) property).get());
                case "smoothing"                        -> gauge.setSmoothing(((BooleanProperty) property).get());
                case "value"                            -> gauge.setValue(((DoubleProperty) property).get());
            }
        });
